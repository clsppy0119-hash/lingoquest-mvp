      ...
      <View style={styles.orderPanel}>
        ...
        <View style={styles.choices}>
          {question.choices.map((choice, choiceIndex) => (
            ...
            >
              <Text style={styles.choiceMark}>{String.fromCharCode(65 + choiceIndex)}</Text>
...
const styles = StyleSheet.create({
  ...
  kicker: { color: '#D88970', fontSize: 9, fontWeight: '900', letterSpacing: 1.5 },
  ...
  round: {
    ...
    backgroundColor: '#192427',
  },
  roundTop: { color: colors.muted, fontSize: 8, fontWeight: '900' },
  roundValue: { color: colors.gold, fontWeight: '900', fontSize: 17 },
  frontLine: {
    height: 120,
    flexDirection: 'row',
    alignItems: 'center',
  ...
  capital: { width: 88, alignItems: 'center' },
  enemy: { width: 75, alignItems: 'center' },
  unitIcon: { color: '#EACB82', fontSize: 43, lineHeight: 48 },
  unitName: { color: '#DAD2B8', fontSize: 7, fontWeight: '900', letterSpacing: 1 },
  clash: {
    flex: 1,
    height: 42,
    justifyContent: 'center',
  ...
  track: { position: 'absolute', left: 0, top: 0, bottom: 0, backgroundColor: '#86513F' },
  swords: { color: '#FFE29A', fontSize: 25, textAlign: 'center' },
  orderPanel: {
  ...
  choiceArrow: { color: colors.gold, fontSize: 26, marginRight: 13 },
  hint: {
    marginTop: 'auto',
    color: colors.muted,
    textAlign: 'center',
